scoreboard players set @s chk.success 
...
execute as @s[scores={chk.success=1}] run summon armor_stand ~ ~ ~ {NoGravity:1b, Small:1b, Invisible:1b, Marker:1b, ArmorItems:[{}, {}, {}, {id:"minecraft:diamond_hoe", Count:1b, tag:{Unbreakable:1b, Damage:141}}], Tags:[chk.iron_candelabra, chk.table_item]}
