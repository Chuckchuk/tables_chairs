...
# There's no function "tables_chairs:tables/place/has_color"
#Run Color Detection
...
#Run Trapdoor
execute as @e[type=minecraft:armor_stand,tag=chk.table] at @s run function tables_chairs:tables/trapdoor/trapdoor
...
# Move inside "tables_chairs:table/trapdoor/trapdoor"
